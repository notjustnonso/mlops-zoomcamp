...
def notify_exc_by_email(exc):
    ...
    flow_run_name = context.flow_run.name # couldn't get function to work because of that line
...
@flow
def main_flow(
    train_path: str = "~/Desktop/MLOps/homework/mlops-zoomcamp/prefect_homework/data/green_tripdata_2023-02.parquet",
    val_path: str = "~/Desktop/MLOps/homework/mlops-zoomcamp/prefect_homework/data/green_tripdata_2023-03.parquet",
) -> None:
